...
}__attribute__((packed)) peci_crashdump_discovery_req_t;

typedef struct
{
    unsigned char completion_code;  /*!< Completion code */
    union peci_data data;            /*!< Response data */
}__attribute__((packed)) peci_crashdump_discovery_res_t;
...
int peci_cmd_rdiamsrex(char dev_id, char target, char domain, char xmit_feedback, char awfcs, int *read_len,  unsigned char *pecirdiamsrreq, unsigned char *pecirdiamsrres);
int peci_cmd_crashdump_discovery(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char *pecicrashdumpreq, unsigned char *pecicrashdumpres);
int peci_cmd_crashdump_getframe(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char *pecicrashdumpreq, unsigned char *pecicrashdumpres);
int peci_cmd_rdendpointconfig_pci(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char* pecirdendpointreq, unsigned char *pecirdendpointres);
int peci_cmd_rdendpointconfig_mmio(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char* pecirdendpointreq, unsigned char *pecirdendpointres);
int peci_cmd_wrendpointconfig_pci(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char* pecirdendpointreq, unsigned char *pecirdendpointres);
int peci_cmd_wrendpointconfig_mmio(char dev_id, char target, char domain, char Xmit_Feedback, char awfcs, int *read_len, unsigned char* pecirdendpointreq, unsigned char *pecirdendpointres);
