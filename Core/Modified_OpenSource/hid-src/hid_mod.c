...
{
    int retVal = 0;
    uint8 DevNo = (uint8)hid_device_driver.devnum; /* Fortify [Type Mismatch: Signed to Unsigned]:: False Positive *//* Reason for False Positive - Casting reture value as unsigned int8 parameter to fit return value. */
...
HidIoctl (unsigned int cmd,unsigned long arg, int* RetVal)
{
	...
	DevNo = (uint8)hid_device_driver.devnum; /* Fortify [Type Mismatch: Signed to Unsigned]:: False Positive *//* Reason for False Positive - Casting reture value as unsigned int8 parameter to fit return value. */
	switch (cmd)
	{
	case USB_MOUSE_DATA:
...
FillDevInfo (IUSB_DEVICE_INFO* iUSBDevInfo)
{
	...
	iUSBDevInfo->DevNo      = (uint8)hid_device_driver.devnum; /* Fortify [Type Mismatch: Signed to Unsigned]:: False Positive *//* Reason for False Positive - Casting reture value as unsigned int8 parameter to fit return value. */
