...
#define NUM_TX_BUFS (16) // MAX number for accepting network packets. Enlarge to 16(as 2^4) to avoid too many warning message "ERROR: did not get TX buffer and so dropping" occurred.
...
typedef struct NET_DEVICE
{
	...
	/* OS independent details */
	uint32 Mtu; /* Fix for fortify [Type Mismatch: Signed to Unsigned].*/
