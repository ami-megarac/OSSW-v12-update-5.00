...
/* LPC_RST_L in Ethanol-X is GPIOAC[7] */
#define GPIO_BASE           0x1E780000
#define GPIO_LPC_RST_DV     (GPIO_BASE + 0x1E8)    //GPIOAC Data Value Register
#define GPIO_LPC_RST_DIR    (GPIO_BASE + 0x1EC)    //GPIOAC Direction Register
